...
$storageFile = 'hbk-data.json';
$uploadDir   = 'uploads-hbk/';
$allData     = [];
...
<head>
    ...
    <link rel="stylesheet" href="stylesheets/demo-hbk.css">
...
<header>
    <div class="logo">HBK Map</div>
    <div class="menu">
        <a href="startseite.html">Counter-Cybernetics |</a>
        <a href="/mapping-hbk/tool-hbk.php" target="_blank">Workshop Tool</a>
    </div>
...
<div class="menumobil">
        <a href="startseite.html">Counter-Cybernetics |</a>
        <a href="/mapping-hbk/tool-hbk.php" target="_blank">Workshop Tool</a>
    <a href="pdf.php" target="_blank" id="zine">Zine erstellen</a>
    <div class="close"></div>
</div>
...
<div class="demolayout">
    ...
    <div class="buttons">
        ...
        <button id="zine">    <a href="pdf.php" target="_blank" id="zine">Zine erstellen</a></button>
